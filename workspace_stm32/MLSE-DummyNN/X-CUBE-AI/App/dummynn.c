...
#define AI_DUMMYNN_MODEL_SIGNATURE     "41dda347af22f9fd43c4e2bdce154c6f"
...
#define AI_TOOLS_DATE_TIME   "Mon Jan  8 14:34:55 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 5, 20, 1, 1), AI_STRIDE_INIT(4, 4, 20, 400, 400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 20, 1, 1, 1), AI_STRIDE_INIT(4, 4, 80, 80, 80),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_DUMMYNN_OUT_NUM, &dense_1_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_dummynn_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_dummynn_activations_map[0] + 0);
    input_0_output_array.data_start = AI_PTR(g_dummynn_activations_map[0] + 0);
    
    dense_dense_output_array.data = AI_PTR(g_dummynn_activations_map[0] + 20);
    dense_dense_output_array.data_start = AI_PTR(g_dummynn_activations_map[0] + 20);
    
    dense_output_array.data = AI_PTR(g_dummynn_activations_map[0] + 20);
    dense_output_array.data_start = AI_PTR(g_dummynn_activations_map[0] + 20);
    ...
    dense_1_output_array.data = AI_PTR(g_dummynn_activations_map[0] + 4);
    dense_1_output_array.data_start = AI_PTR(g_dummynn_activations_map[0] + 4);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_dummynn_weights_map, 1, params)) {
    ...
    dense_dense_weights_array.data = AI_PTR(g_dummynn_weights_map[0] + 0);
    dense_dense_weights_array.data_start = AI_PTR(g_dummynn_weights_map[0] + 0);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_dummynn_weights_map[0] + 400);
    dense_dense_bias_array.data_start = AI_PTR(g_dummynn_weights_map[0] + 400);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_dummynn_weights_map[0] + 480);
    dense_1_dense_weights_array.data_start = AI_PTR(g_dummynn_weights_map[0] + 480);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_dummynn_weights_map[0] + 560);
    dense_1_dense_bias_array.data_start = AI_PTR(g_dummynn_weights_map[0] + 560);
