...
/******************************************************************************/
#define AI_DUMMYNN_MODEL_NAME          "dummynn"
#define AI_DUMMYNN_ORIGIN_MODEL_NAME   "dummy_nn"

/******************************************************************************/
#define AI_DUMMYNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_DUMMYNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_DUMMYNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_DUMMYNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_DUMMYNN_IN \
  ai_dummynn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_DUMMYNN_IN_SIZE { \
  AI_DUMMYNN_IN_1_SIZE, \
}
#define AI_DUMMYNN_IN_SIZE_BYTES { \
  AI_DUMMYNN_IN_1_SIZE_BYTES, \
}
#define AI_DUMMYNN_IN_1_CHANNEL     (5)
#define AI_DUMMYNN_IN_1_SIZE        (5)
#define AI_DUMMYNN_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_DUMMYNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_DUMMYNN_OUT \
  ai_dummynn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_DUMMYNN_OUT_SIZE { \
  AI_DUMMYNN_OUT_1_SIZE, \
}
#define AI_DUMMYNN_OUT_SIZE_BYTES { \
  AI_DUMMYNN_OUT_1_SIZE_BYTES, \
}
#define AI_DUMMYNN_OUT_1_CHANNEL     (1)
#define AI_DUMMYNN_OUT_1_SIZE        (1)
#define AI_DUMMYNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_DUMMYNN_N_NODES (4)
 ...
 * @ref ai_dummynn_create. Both the activations memory buffer 
 ...
 * using @ref ai_dummynn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_dummynn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_dummynn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_DUMMYNN_*
 * defines into file @ref dummynn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
