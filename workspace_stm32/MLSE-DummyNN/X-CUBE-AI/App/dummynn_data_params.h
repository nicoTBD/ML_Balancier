...
#define AI_DUMMYNN_DATA_ACTIVATIONS_SIZES \
  { 100, }
#define AI_DUMMYNN_DATA_ACTIVATIONS_SIZE     (100)
#define AI_DUMMYNN_DATA_ACTIVATIONS_COUNT    (1)
#define AI_DUMMYNN_DATA_ACTIVATION_1_SIZE    (100)



#define AI_DUMMYNN_DATA_WEIGHTS_SIZES \
  { 564, }
#define AI_DUMMYNN_DATA_WEIGHTS_SIZE         (564)
#define AI_DUMMYNN_DATA_WEIGHTS_COUNT        (1)
#define AI_DUMMYNN_DATA_WEIGHT_1_SIZE        (564)
